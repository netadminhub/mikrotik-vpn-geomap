...
export default function MarketingMap() {
  ...
  // ResizeObserver: whenever the flex container gives the map div a new
  // height (which happens after the first paint), tell ECharts to resize.
  useEffect(() => {
  ...
  const initChart = () => {
    ...
    // Force an immediate resize after setOption so ECharts fills
    // whatever height flexbox has already assigned to the container.
    chart.resize();
  };
  ...
  return (
    <div className="marketing-map-wrapper">
      ...
      {/* map-container: the only flex-grow element — absorbs all leftover space */}
      ...
      <div className="marketing-footer">
        <div className="footer-content">
          <p className="footer-tagline">
            Built between the pings with ❤️ by{' '}
            <a href="https://instagram.com/ramtiin.ir" target="_blank" rel="noopener noreferrer" className="author-link">
              Ramtin
            </a>
          </p>
          <p className="footer-contact">
            Order now:{' '}
            <a href="https://t.me/NetAdminPlus" target="_blank" rel="noopener noreferrer">
              @NetAdminPlus
            </a>
          </p>
          <div className="social-links">
            <a href="https://instagram.com/netadminplus" target="_blank" rel="noopener noreferrer" className="social-link instagram" title="Instagram">
            ...
            <a href="https://youtube.com/netadminplus" target="_blank" rel="noopener noreferrer" className="social-link youtube" title="YouTube">
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
              </svg>
            </a>
            <a href="https://x.com/netadmiinplus" target="_blank" rel="noopener noreferrer" className="social-link twitter" title="X (Twitter)">
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="https://linkedin.com/in/ramtin-rahmani" target="_blank" rel="noopener noreferrer" className="social-link linkedin" title="LinkedIn">
              <svg viewBox="0 0 24 24" fill="currentColor">
